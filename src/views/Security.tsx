  ...
  return (
    <div className="inline-block">
      ...
      <Modal
        ...
        isOpen={modalOpen}
      >
        <div className="px-1 md:px-8 lg:px-16">
          <h2 className="text-center mb-4">About Security</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            for those who steal the code and redistribute it without my
            knowledge.
          </p>
          <p className="mb-8">
          ...
          <p>
            Settings refers to the configurable options on the app; which types
            of characters to include, password length, etc.
          </p>
        </div>
      </Modal>
    </div>
